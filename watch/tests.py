...
class CommentTestClass(TestCase):
    # Set up method
    def setUp(self):
        self.Comm= Post( id = '1', comment ='Nice',post='Happy', user = 'Chacha')
...
class HealthTestClass(TestCase):
    # Set up method
    def setUp(self):
        self.Heal= Heal( id = '1', name ='Hospital',email='hospital@gmail.com', contact = '707594873',neighbourhood='Membley' )
